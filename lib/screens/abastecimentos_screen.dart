              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (v) => v!.isEmpty ? 'Informe o tipo de combustível' : null,
                  ),
                  TextFormField(
                    controller: veiculoController,
                    decoration: const InputDecoration(labelText: 'Veículo'),
                    validator: (v) => v!.isEmpty ? 'Informe o veículo' : null,
                  ),
                ],
              ),
            ),
                ...
                return Card(
                  ...
                  child: ListTile(
                    leading: CircleAvatar(
                      ...
                      child: const Icon(Icons.local_gas_station, color: Colors.deepPurple),
                    ),
                    title: Text(
